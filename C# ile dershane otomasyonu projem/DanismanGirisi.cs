...
{
    public partial class DanismanGirisi : Form
    {
        ...
        {
            DanismanSifreSıfırlamakicinOnaylama dssio = new DanismanSifreSıfırlamakicinOnaylama();
            dssio.Show();
        }

        private void DanismanGirisi_Load(object sender, EventArgs e)
        {
